...
if [ ! -d $f ]; then
  ...
  then
    ...
    curl -X PUT -T $f -u ${BINTRAY_USER}:${BINTRAY_API_KEY} https://api.bintray.com/content/${BINTRAY_OWNER}/${BINTRAY_REPO}/$f;publish=0;override=1
  else
    curl -X PUT -T $f -u ${BINTRAY_USER}:${BINTRAY_API_KEY} https://api.bintray.com/content/${BINTRAY_OWNER}/${BINTRAY_REPO}/${PCK_NAME}/${PCK_VERSION}/${PCK_VERSION}/$f;publish=0;override=
1
  fi
  echo ""
fi
...
do
  ...
  curl -X PUT -T $f -u ${BINTRAY_USER}:${BINTRAY_API_KEY} https://api.bintray.com/content/${BINTRAY_OWNER}/${BINTRAY_REPO}/${PCK_NAME}/${PCK_VERSION}/${PCK_VERSION}/$f;publish=0;override=1
  echo ""
done
...
do
  ...
  curl -X PUT -T $f -u ${BINTRAY_USER}:${BINTRAY_API_KEY} https://api.bintray.com/content/${BINTRAY_OWNER}/${BINTRAY_REPO}/${PCK_NAME}/${PCK_VERSION}/${PCK_VERSION}/$f;bt_package=${PCK_NAME
};bt_version=${PCK_VERSION};publish=0;override=1
  echo ""
done
